...
public class CreateTestEmployersPresenter : ActionResultPresenterBase<CreateTestEmployersUseCase>, CreateTestEmployersUseCase.IOutput
{
    public CreateTestEmployersPresenter(ILogger logger, IApiMapper mapper)
        : base(logger, mapper)
    { }
